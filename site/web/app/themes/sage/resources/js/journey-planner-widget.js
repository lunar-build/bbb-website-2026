...
window.initJourneyPlannerPlaces = () => {
  document.querySelectorAll('.c-journey-planner-widget__form[data-variant="plan_route"]').forEach((form) => {
    ...
    form.addEventListener('submit', (event) => {
      ...
      const missing = [fromInput, toInput].find((input) => input && !input.dataset.lat);
